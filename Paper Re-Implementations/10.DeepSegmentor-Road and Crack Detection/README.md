...
# DeepSegmentor
- This is repo is a Pytorch re-implementation of [DeepCrack](https://github.com/yhlleo/DeepCrack) and [RoadNet](https://github.com/yhlleo/RoadNet) projects as well as corresponding papers.
...
## Datasets
 ...
 - CrackNet:[**Crack Detection Dataset**](https://github.com/yhlleo/DeepCrack)
 - RoadNet: [**Multi-task Road Detection Dataset**](https://github.com/yhlleo/RoadNet)
...
- This project is originally taken from this [**work**](https://github.com/yhlleo/DeepSegmentor)

- Link to [** Google Colab Version**](https://colab.research.google.com/drive/13qSMnU1ERU7riHMMiv9MEEr7VTMhfZs9?usp=sharing) provided by [**DZDL/DeepSegmentor**](https://github.com/DZDL/DeepSegmentor)).
