...
- A PyTorch Re-implementation of [Jiaxuan You](https://cs.stanford.edu/~jiaxuan/)'s 2017 Crop Yield Prediction Paper-[**Deep Gaussian Process for Crop Yield Prediction Based on Remote Sensing Data**](https://cs.stanford.edu/~ermon/papers/cropyield_AAAI17.pdf)
...
- It draws from the original [TensorFlow implementation](https://github.com/JiaxuanYou/crop_yield_prediction).
...
## Inspiration
- This work is inspired by **Gabriel Tseng**.
